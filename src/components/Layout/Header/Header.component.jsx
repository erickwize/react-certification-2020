                ...
                <span className="header__theme__switch">
                    <span className="header__theme__switch__inner">
                        <span className="header__theme__switch__input">
                            <input className="header__theme__switch__input__cb" type="checkbox" name="theme"/>
                            <span className="header__theme__switch__input__ball"></span>
                        </span>
                    </span>
                    <span className="header__theme__switch__track"></span>
                </span>
